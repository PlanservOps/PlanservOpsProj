...
const PreventiveOverviewChart = () => {
  return (
    <Link to="/Checklist"> {/* 👈 torna o card clicável */}
      <motion.div
        className="bg-gray-800 bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl p-6 border border-gray-700 cursor-pointer hover:shadow-xl transition-shadow"
